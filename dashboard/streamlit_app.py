...
if __name__ == "__main__":
    ...
    if exp == "No Idea" and edu == "High School":
        ...
        st.write("#### Here are some websites that will be helpfull for you")
        st.write("[Kaggle Data Visualisation Course](https://www.kaggle.com/learn/data-visualization)")
        st.write("[Coursera Data Visualisation Course](https://www.coursera.org/learn/datavisualization)")
        ...
        st.write("#### There are lots of new papers published for DS/ML each day, here is a plot to see how much the average number of papers have increased in past decade.")
